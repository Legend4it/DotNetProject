...
namespace FeeCalculation.MockData
{
    public static class MockTimes
    {
        public static DateTime[] GetTimes()
        {
            ...
            DateTime therdPass = DateTime.ParseExact("2019-03-08 15:29:20", "yyyy-MM-dd HH:mm:ss",
                                                   System.Globalization.CultureInfo.InvariantCulture);

            DateTime forthPass = DateTime.ParseExact("2019-03-08 18:29:00", "yyyy-MM-dd HH:mm:ss",
                                                   System.Globalization.CultureInfo.InvariantCulture);

            DateTime fithPass = DateTime.ParseExact("2019-03-08 20:20:30", "yyyy-MM-dd HH:mm:ss",
                                                   System.Globalization.CultureInfo.InvariantCulture);
